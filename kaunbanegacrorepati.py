...
def kbc():
    ...
    question = ["Current Railway Minister of India is",
                ...
                "Which city is known as Pink City in India?","Who wrote India's National Anthem?",
                "How many major religions are there in India?","When is the National Hindi Diwas celebrated?",
                "How many states are there in India?","Where in India Gate located?",
    ...
    option = ["A Mamta Banarjee  B Ram Vilash  C Ashwini Vaishnaw D Piyush Goyal",
              "A Agni B Indra C Hanuman D Ganesha","A Money B Flowers C Leaves D Fruits",
              ...
              "A 28 B 29 C 31 D 31","A Agra B Punjab C Mumbai D New Delhi",
